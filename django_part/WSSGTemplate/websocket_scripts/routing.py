...
from WSSGTemplate.websocket_scripts import consumers_basic, consumers_basic_layer, \
    consumer_example_lobby, consumer_example_game, consumer_chat, consumer_leaderboard

# the websocket urls.

websocket_urlpatterns = [
    re_path(r'ws/basic/$', consumers_basic.BasicWSServer.as_asgi()),
    re_path(r'ws/layer/(?P<layer_name>\w+)/$', consumers_basic_layer.BasicWSServerLayer.as_asgi()),
