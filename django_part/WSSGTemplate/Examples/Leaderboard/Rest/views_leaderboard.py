...
def get_complete_leaderboard_by_category(request):
    ...
    leaderboard = utilities.search_object_by_attribute(Leaderboard, category=category_req)
...
def get_entry_of_player_in_category(player_name, category):
    leaderboard = utilities.search_object_by_attribute(Leaderboard, category=category)
    if leaderboard is None:
        return None, None
